...
* Листы записи ЕГРЮЛ:
  ...
  {% include doc-link.html text="06.12.2018" uri="files/docs/registry_2018-12-06_01.jpg" %} | {% include doc-link.html text="лист 2" uri="files/docs/registry_2018-12-06_02.jpg" %}
...
26. {% include doc-link.html text="Положение о режиме занятий обучающихся в ГКУ ЦССВ «Сколковский»" uri="files/docs/DOC073.pdf" %}.
27. {% include doc-link.html text="Положение о порядке пользования бибилиотеками и информационными ресурсами, доступа к информационно-телекоммуникационным сетям и базам данных, учебным и методическим материалам, музейным фондам, материально-техническим средствам, обеспечения образовательной деятельности." uri="files/docs/DOC074.pdf" %}.
...
29. {% include doc-link.html text="Положение о правилах приема обучающихся на обучение по дополнительным общеобразовательным программам ГКУ ЦССВ «Сколковский»" uri="files/docs/DOC072.pdf" %}.